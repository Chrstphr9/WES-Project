...
const firstPage = () => {
    ...
    const handleChange = (e) => {
        ...
        updateProgress(); // Update progress on input change
    };

    // Calculate and update progress bar based on filled fields
        ...
        <div className="max-w-lg mx-auto p-6 bg-white shadow-lg rounded-lg">
            ...
            <div className="relative pt-5 h-[870px] w-full max-w-[600px] mx-auto bg-white">
                ...
                <form>
                    ...
                    {/* Buttons */}
                    <div className="flex justify-between items-center w-auto px-5 pt-[70px] ">
                        <button type="button" className="text-black font-bold text-xs lg:text-lg">Skip For Now</button>
                        <button
                            type="submit"
                            className="bg-[#0256B2] lg:px-[70px] lg:py-3 lg:text-xl text-white lg:font-bold text-sm px-5 py-2 rounded-lg"
                            onClick={(e) => {
                                e.preventDefault();
                                setIsPopupOpen(true);
                            }}
